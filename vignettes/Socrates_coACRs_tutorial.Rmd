...
`Socrates` relies on the R package `cicero`, developed by the Trapenll and Shendure labs to identify co-accessible ACRs. Please cite their work (here) if using `Socrates` to identify co-accessible regions.
